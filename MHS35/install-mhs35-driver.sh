...
sudo cp ./MHS35/mhs35-overlay.dtbo /boot/overlays/
...
sudo cp -rf ./MHS35/99-calibration.conf  /etc/X11/xorg.conf.d/99-calibration.conf
#sudo cp -rf ./MHS35/99-fbturbo  /usr/share/X11/xorg.conf.d/99-fbturbo.conf
sudo cp -rf ./MHS35/99-fbturbo-fbcp  /usr/share/X11/xorg.conf.d/99-fbturbo.conf
#sudo cp -rf ./MHS35/rc.local /etc/rc.local
sudo cp -rf ./MHS35/mhs35-fbcp.service /etc/systemd/system/mhs35-fbcp.service
#sudo cp -rf ./MHS35/force-fb_ili9486.service /etc/systemd/system/force-fb_ili9486.service
#check if do i actually require this inittab.
sudo cp ./MHS35/inittab /etc/
